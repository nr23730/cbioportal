...
var MutpatPlotsView = function() {
    ...
    function importDefaultSettings() {
        ...
        plotsOpts.style = jQuery.extend(true, {}, MutpatPlotsBoilerplate.style);
        plotsOpts.canvas = jQuery.extend(true, {}, MutpatPlotsBoilerplate.canvas);
        plotsOpts.elem = jQuery.extend(true, {}, MutpatPlotsBoilerplate.elem);      
        plotsOpts.text = jQuery.extend(true, {}, MutpatPlotsBoilerplate.text);
        plotsOpts.names = jQuery.extend(true, {}, MutpatPlotsBoilerplate.names);
    }
    ...
    function initPlots() {
        //Init Plots
        var mutpatPlots = new ScatterPlots();
        mutpatPlots.init(plotsOpts, dataArr, dataAttr, false, true);
        PlotsHeader.init(
            plotsOpts.names, 
        ...
        if (settings.enable_log_scale) {
            $("#" + plotsOpts.names.log_scale_x).change(function() {
                mutpatPlots.updateScaleX(plotsOpts.names.log_scale_x);
            });
            $("#" + plotsOpts.names.log_scale_y).change(function() {
                mutpatPlots.updateScaleY(plotsOpts.names.log_scale_y);
            });
        }  
        ...
        function loadSvg(type, _filename) {
            ...
            mutpatPlots.updateTitleHelp(plotsOpts.names.log_scale_x, plotsOpts.names.log_scale_y);      
        }
    }
